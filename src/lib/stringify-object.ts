// @ts-nocheck
// Forked from https://github.com/yeoman/stringify-object
// Some esm error in its dependency

const isRegexp = (v: any) => v instanceof RegExp;
...
export default function stringifyObject(input: any, options?: any, pad?: any) {
	const seen: any[] = [];
